...
//
///////////////////////////////////////////
Shader "Shaun/ReflectiveSurfaces/MaroonLevelFloor" {
Properties {
...
void main()
{
    ...
    u_xlat16_2.x = u_xlat16_3.x * u_xlat16_2.x + (-u_xlat16_6);
    u_xlat16_3.x = in_POSITION0.y * 0.0952399969 + 1.0;
    vs_TEXCOORD3.x = u_xlat16_3.x * u_xlat16_2.x + u_xlat16_6;
    u_xlat16_2.xy = (-_MetalMult.zw) + _MetalMult.xy;
    u_xlat16_2.xy = _RefTexAdj.ww * u_xlat16_2.xy + _MetalMult.zw;
    u_xlat16_2.x = (-u_xlat16_2.y) + u_xlat16_2.x;
    vs_TEXCOORD3.y = u_xlat16_3.x * u_xlat16_2.x + u_xlat16_2.y;
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
    vs_TEXCOORD2.zw = u_xlat0.zw;
    u_xlat16_7.xyz = u_xlat0.xyw * vec3(0.5, 0.5, 0.5);
    vs_TEXCOORD2.x = u_xlat16_7.z + u_xlat16_7.x;
    vs_TEXCOORD2.y = u_xlat16_7.y * _ProjectionParams.x + u_xlat16_7.z;
    u_xlat16_7.xyz = _AmbientT.xyz + (-_AmbientB.xyz);
    u_xlat16_3.xyz = u_xlat16_3.xxx * u_xlat16_7.xyz + _AmbientB.xyz;
    u_xlat16_2.xyw = vec3(u_xlat16_14) * u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat4 = (-u_xlat0.y) + _RefTexAdj.y;
    u_xlat0.z = u_xlat4 * _RefTexAdj.x;
    ...
    u_xlat16_3.xyz = (-u_xlat16_2.xyz) * vs_COLOR0.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_1.xyz = (-u_xlat16_1.xyz) * u_xlat16_3.xyz + vec3(0.920000017, 0.920000017, 0.920000017);
    u_xlat16_3.xyz = u_xlat16_0.xyz + (-u_xlat16_1.xyz);
    u_xlat16_1.xyz = vs_TEXCOORD3.yyy * u_xlat16_3.xyz + u_xlat16_1.xyz;
    u_xlat16_1.xyz = (-u_xlat16_2.xyz) * vs_COLOR0.xyz + u_xlat16_1.xyz;
    u_xlat16_13 = u_xlat16_2.w * vs_TEXCOORD3.x;
    u_xlat16_3.xyz = u_xlat16_2.xyz * vs_COLOR0.xyz;
    SV_Target0.xyz = vec3(u_xlat16_13) * u_xlat16_1.xyz + u_xlat16_3.xyz;
    SV_Target0.w = 1.0;
    return;
}
