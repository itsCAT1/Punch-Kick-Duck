...
//
///////////////////////////////////////////
Shader "Shaun/3dObjShaders/NoTex/3DObj+LightbakedUV2_NoTex" {
Properties {
_DiffuseBaseCol ("Diffuse base Color", Color) = (1,1,1,1)
_GradientSubColor ("Gradient additive color", Vector) = (0,0,0,1)
_ObjCol ("Object Base Color", Color) = (1,1,1,1)
_LStr ("Light str", Float) = 1
}
SubShader {
...
uniform 	mediump vec4 _ObjCol;
uniform 	mediump float _LStr;
...
void main()
{
    ...
    u_xlat16_2.xyz = _ObjCol.xyz * _DiffuseBaseCol.xyz + u_xlat16_2.xyz;
    vs_COLOR0.xyz = in_TEXCOORD1.xyz * vec3(_LStr) + u_xlat16_2.xyz;
    vs_COLOR0.w = 1.0;
    return;
}
