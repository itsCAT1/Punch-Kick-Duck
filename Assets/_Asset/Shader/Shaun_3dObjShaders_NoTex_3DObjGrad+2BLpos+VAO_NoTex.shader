...
uniform 	mediump vec3 _ObjectCol;
...
void main()
{
    ...
    u_xlat16_27 = u_xlat16_27 * _BackLightPos.w;
    u_xlat16_27 = (-u_xlat16_27) * 0.00499999989 + 1.0;
    ...
    u_xlat16_28 = u_xlat0.z * u_xlat24 + 0.800000012;
    u_xlat16_28 = max(u_xlat16_28, _BackLightLimitForFrontFaces);
    ...
    u_xlat16_11 = dot(u_xlat0.xyz, in_POSITION0.xyz);
    ...
    u_xlat16_13 = inversesqrt(u_xlat16_19);
    u_xlat16_19 = u_xlat16_19 * _BackLight2Pos.w;
    u_xlat16_19 = (-u_xlat16_19) * 0.00499999989 + 1.0;
    ...
    u_xlat16_19 = (-in_COLOR0.z) + 1.0;
    u_xlat16_3.x = max(u_xlat16_19, u_xlat16_3.x);
    u_xlat16_5.xyz = u_xlat16_3.xxx * _ShadowSub.xyz;
    u_xlat16_3.x = (-u_xlat16_11) * _GradientLightCut + 1.0;
    u_xlat16_7.xyz = vec3(u_xlat16_11) * _GradientSubColor.xyz;
    u_xlat16_7.xyz = _ObjectCol.xyz * _DiffuseBaseCol.xyz + u_xlat16_7.xyz;
    u_xlat16_3.x = u_xlat16_3.x * u_xlat16_27;
    u_xlat16_3.xyz = u_xlat16_3.xxx * _MainLightCol.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * in_COLOR0.xxx + u_xlat16_5.xyz;
    u_xlat16_3.xyz = u_xlat16_6.xyz * in_COLOR0.yyy + u_xlat16_3.xyz;
    u_xlat16_3.xyz = u_xlat16_4.xzw * in_COLOR0.yyy + u_xlat16_3.xyz;
