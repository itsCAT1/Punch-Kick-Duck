...
void main()
{
    u_xlat16_0.x = _VBlur * _RefTexAdj.z;
    u_xlat1.xy = vs_TEXCOORD1.xy / vs_TEXCOORD1.ww;
    u_xlat2 = (-u_xlat1.y) + _RefTexAdj.y;
    u_xlat16_3.y = u_xlat2 * _RefTexAdj.x + u_xlat16_0.x;
    u_xlat16_3.w = u_xlat2 * _RefTexAdj.x + (-u_xlat16_0.x);
    u_xlat1.w = u_xlat2 * _RefTexAdj.x;
    u_xlat1.y = u_xlat16_3.y;
    u_xlat16_2.xyz = texture2D(_MainTex, u_xlat1.xw).xyz;
    u_xlat16_4.xyz = texture2D(_MainTex, u_xlat1.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + u_xlat16_4.xyz;
    u_xlat1.y = u_xlat16_3.w;
    u_xlat16_2.xyz = texture2D(_MainTex, u_xlat1.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz + u_xlat16_2.xyz;
    u_xlat16_2 = u_xlat1.xxxx + vec4(0.00300000003, -0.00300000003, 0.00180000009, -0.00180000009);
    u_xlat4.xz = u_xlat1.xx + vec2(-0.00180000009, 0.00180000009);
    u_xlat1.z = u_xlat16_2.x;
    u_xlat16_5.xyz = texture2D(_MainTex, u_xlat1.zw).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz + u_xlat16_5.xyz;
    u_xlat1.z = u_xlat16_2.y;
    u_xlat16_3.xz = u_xlat16_2.zw;
    u_xlat16_1.xyz = texture2D(_MainTex, u_xlat1.zw).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz + u_xlat16_1.xyz;
    u_xlat16_1.xyz = texture2D(_MainTex, u_xlat16_3.xy).xyz;
    u_xlat16_5.xyz = texture2D(_MainTex, u_xlat16_3.zw).xyz;
    u_xlat4.yw = u_xlat16_3.yw;
    u_xlat16_0.xyz = u_xlat16_0.xyz + u_xlat16_1.xyz;
    u_xlat16_0.xyz = u_xlat16_5.xyz + u_xlat16_0.xyz;
    u_xlat16_1.xyz = texture2D(_MainTex, u_xlat4.xy).xyz;
    u_xlat16_4.xyz = texture2D(_MainTex, u_xlat4.zw).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz + u_xlat16_1.xyz;
    u_xlat16_0.xyz = u_xlat16_4.xyz + u_xlat16_0.xyz;
    u_xlat16_3.xyz = (-u_xlat16_0.xyz) * vec3(0.111000001, 0.111000001, 0.111000001) + vec3(1.0, 1.0, 1.0);
    u_xlat16_1 = texture2D(_SurfaceTex, vs_TEXCOORD0.xy);
    u_xlat16_6.xyz = u_xlat16_1.xyz + vs_COLOR1.xyz;
    u_xlat16_24 = u_xlat16_1.w * vs_TEXCOORD2.x;
    u_xlat16_7.xyz = (-u_xlat16_6.xyz) * vs_COLOR0.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_3.xyz = (-u_xlat16_3.xyz) * u_xlat16_7.xyz + vec3(0.920000017, 0.920000017, 0.920000017);
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(0.111000001, 0.111000001, 0.111000001) + (-u_xlat16_3.xyz);
    u_xlat16_0.xyz = vs_TEXCOORD2.yyy * u_xlat16_0.xyz + u_xlat16_3.xyz;
    u_xlat16_0.xyz = (-u_xlat16_6.xyz) * vs_COLOR0.xyz + u_xlat16_0.xyz;
    u_xlat16_3.xyz = u_xlat16_6.xyz * vs_COLOR0.xyz;
    SV_Target0.xyz = vec3(u_xlat16_24) * u_xlat16_0.xyz + u_xlat16_3.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat1.w = u_xlat2 * _RefTexAdj.x;
    u_xlat1.y = u_xlat16_3.y;
    u_xlat16_2.xyz = texture(_MainTex, u_xlat1.xw).xyz;
    ...
    u_xlat4.xz = u_xlat1.xx + vec2(-0.00180000009, 0.00180000009);
    u_xlat1.z = u_xlat16_2.x;
    u_xlat16_5.xyz = texture(_MainTex, u_xlat1.zw).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz + u_xlat16_5.xyz;
    u_xlat1.z = u_xlat16_2.y;
    u_xlat16_3.xz = u_xlat16_2.zw;
    u_xlat16_1.xyz = texture(_MainTex, u_xlat1.zw).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz + u_xlat16_1.xyz;
    u_xlat16_1.xyz = texture(_MainTex, u_xlat16_3.xy).xyz;
    u_xlat16_5.xyz = texture(_MainTex, u_xlat16_3.zw).xyz;
    u_xlat4.yw = u_xlat16_3.yw;
    u_xlat16_0.xyz = u_xlat16_0.xyz + u_xlat16_1.xyz;
    u_xlat16_0.xyz = u_xlat16_5.xyz + u_xlat16_0.xyz;
    u_xlat16_1.xyz = texture(_MainTex, u_xlat4.xy).xyz;
