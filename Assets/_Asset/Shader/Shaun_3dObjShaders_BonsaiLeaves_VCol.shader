...
//
///////////////////////////////////////////
Shader "Shaun/3dObjShaders/BonsaiLeaves_VCol" {
Properties {
...
void main()
{
    ...
    gl_Position = u_xlat0;
    u_xlat16_14 = in_COLOR0.w * 0.5 + 0.5;
    u_xlat16_2.xyz = vec3(u_xlat16_14) * u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * in_TEXCOORD0.xxx;
    u_xlat16_3.xyz = vec3(u_xlat16_14) * _MainLightCol.xyz;
    u_xlat0.x = (-u_xlat16_14) + 1.0;
    u_xlat16_3.xyz = u_xlat16_3.xyz * in_TEXCOORD0.yyy;
    u_xlat16_3.xyz = u_xlat16_3.xyz * _MainLightDir.www;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _BackLightDir.www + u_xlat16_3.xyz;
    u_xlat0.xyz = _ShadowSub.xyz * u_xlat0.xxx + u_xlat16_2.xyz;
    u_xlat12 = (-in_TEXCOORD0.z) + 1.0;
    u_xlat0.xyz = _ShadowSub.xyz * vec3(u_xlat12) + u_xlat0.xyz;
    vs_TEXCOORD1.xyz = in_COLOR0.xyz * _DiffuseBaseCol.xyz + u_xlat0.xyz;
    vs_TEXCOORD1.w = 1.0;
    return;
}
