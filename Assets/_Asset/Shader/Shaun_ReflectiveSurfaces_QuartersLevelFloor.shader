...
//
///////////////////////////////////////////
Shader "Shaun/ReflectiveSurfaces/QuartersLevelFloor" {
Properties {
...
void main()
{
    ...
    u_xlat16_12 = min((-in_NORMAL0.z), 0.0);
    u_xlat16_17 = u_xlat16_12 + in_NORMAL0.y;
    u_xlat16_12 = u_xlat16_12 + 1.0;
    u_xlat16_3.x = u_xlat16_17 + 1.0;
    u_xlat16_17 = u_xlat16_17 * _EdgeDarkening + 1.0;
    u_xlat16_7 = u_xlat16_2.y * u_xlat16_3.x;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_3.x + (-u_xlat16_7);
    u_xlat1.x = in_POSITION0.y * 0.0952399969 + 1.0;
    vs_TEXCOORD1.x = u_xlat1.x * u_xlat16_2.x + u_xlat16_7;
    u_xlat16_2.xy = (-_MetalMult.zw) + _MetalMult.xy;
    u_xlat16_2.xy = _RefTexAdj.ww * u_xlat16_2.xy + _MetalMult.zw;
    u_xlat16_2.x = (-u_xlat16_2.y) + u_xlat16_2.x;
    vs_TEXCOORD1.y = u_xlat1.x * u_xlat16_2.x + u_xlat16_2.y;
    ...
    u_xlat16_3.xyz = u_xlat1.xxx * u_xlat16_3.xyz + _AmbientB.xyz;
    u_xlat16_2.xyw = vec3(u_xlat16_17) * u_xlat16_3.xyz;
    vs_COLOR0.xyz = vec3(u_xlat16_12) * u_xlat16_2.xyw;
    u_xlat16_2.xyz = _AddColT.xyz + (-_AddColB.xyz);
    u_xlat16_2.xyz = u_xlat1.xxx * u_xlat16_2.xyz + _AddColB.xyz;
    u_xlat0.x = hlslcc_mtx4x4unity_ObjectToWorld[0].x;
    u_xlat0.y = hlslcc_mtx4x4unity_ObjectToWorld[1].x;
    u_xlat0.z = hlslcc_mtx4x4unity_ObjectToWorld[2].x;
    u_xlat16_3.x = dot(u_xlat0.xyz, in_POSITION0.xyz);
    ...
    u_xlat16_3.y = dot(u_xlat0.xyz, in_POSITION0.xyz);
    ...
    u_xlat16_3.z = dot(u_xlat0.xyz, in_POSITION0.xyz);
    u_xlat16_3.xyz = (-u_xlat16_3.xyz) + _BackLightPos.xyz;
    u_xlat16_17 = dot(u_xlat16_3.xyz, u_xlat16_3.xyz);
    u_xlat0.x = u_xlat16_17 * 0.00499999989;
    u_xlat0.x = (-u_xlat0.x) * _BackLightPos.w + 1.0;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat16_17 = u_xlat0.x * u_xlat0.x;
    u_xlat16_3.xyz = vec3(u_xlat16_17) * _BackLightCol.xyz;
    vs_COLOR1.xyz = u_xlat16_3.xyz * _BackLightCol.www + u_xlat16_2.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat5 = (-u_xlat0.y) + _RefTexAdj.y;
    u_xlat0.z = u_xlat5 * _RefTexAdj.x;
    u_xlat16_0.xyz = texture2D(_MainTex, u_xlat0.xz).xyz;
    ...
    u_xlat16_18 = u_xlat16_2.w * vs_TEXCOORD1.x;
    u_xlat2.xyz = (-u_xlat16_3.xyz) * vs_COLOR0.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat1.xyz = (-u_xlat1.xyz) * u_xlat2.xyz + vec3(0.920000017, 0.920000017, 0.920000017);
    u_xlat16_4.xyz = u_xlat16_0.xyz + (-u_xlat1.xyz);
    u_xlat16_4.xyz = vs_TEXCOORD1.yyy * u_xlat16_4.xyz + u_xlat1.xyz;
    u_xlat16_4.xyz = (-u_xlat16_3.xyz) * vs_COLOR0.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat5 = (-u_xlat0.y) + _RefTexAdj.y;
    u_xlat0.z = u_xlat5 * _RefTexAdj.x;
    u_xlat16_0.xyz = texture(_MainTex, u_xlat0.xz).xyz;
    u_xlat1.xyz = (-u_xlat16_0.xyz) + vec3(1.0, 1.0, 1.0);
