...
void main()
{
    ...
    u_xlat16_3.xy = _ShadPosAndScale.zw * _ShadPosAndScale.xy;
    ...
    u_xlat16_3.xy = u_xlat16_2.xy * _ShadPosAndScale.zw + (-u_xlat16_3.xy);
    vs_TEXCOORD1.xy = u_xlat16_3.xy + vec2(0.5, 0.5);
    ...
    u_xlat16_2.xzw = (-u_xlat16_2.xyz) + _LightPos.xyz;
    u_xlat16_2.x = dot(u_xlat16_2.xzw, u_xlat16_2.xzw);
    u_xlat16_2.x = u_xlat16_2.x * _LightPos.w;
    u_xlat16_2.x = (-u_xlat16_2.x) * 0.00499999989 + 1.0;
    ...
    u_xlat16_10 = u_xlat0.x * (-u_xlat0.y) + (-u_xlat0.y);
    u_xlat16_2.x = u_xlat16_10 * u_xlat16_2.x;
    u_xlat16_2.xzw = u_xlat16_2.xxx * _LightCol.xyz;
    vs_COLOR0.xyz = u_xlat16_2.xzw * _LightCol.www;
    u_xlat16_2.x = u_xlat16_2.y + (-_TGradStart);
    u_xlat16_6.x = u_xlat16_2.y + (-_BGradEnd);
    u_xlat16_10 = (-_TGradStart) + _TGradEnd;
    u_xlat16_2.x = u_xlat16_2.x / u_xlat16_10;
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0, 1.0);
    u_xlat16_2.x = u_xlat16_2.x * _TGradCol.w;
    u_xlat16_10 = (-_BGradEnd) + _BGradStart;
    u_xlat16_6.x = u_xlat16_6.x / u_xlat16_10;
    u_xlat16_6.x = clamp(u_xlat16_6.x, 0.0, 1.0);
    u_xlat16_6.x = u_xlat16_6.x * _BGradCol.w;
    u_xlat16_3.xyz = _BGradCol.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_6.xyz = u_xlat16_6.xxx * u_xlat16_3.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_3.xyz = (-u_xlat16_6.xyz) + _TGradCol.xyz;
    vs_COLOR1.xyz = u_xlat16_2.xxx * u_xlat16_3.xyz + u_xlat16_6.xyz;
    return;
}
