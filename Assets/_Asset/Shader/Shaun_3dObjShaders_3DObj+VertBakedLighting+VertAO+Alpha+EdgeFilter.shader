...
//
///////////////////////////////////////////
Shader "Shaun/3dObjShaders/3DObj+VertBakedLighting+VertAO+Alpha+EdgeFilter" {
Properties {
...
void main()
{
    u_xlat16_0.x = dFdx(vs_TEXCOORD1.x);
    u_xlat16_2 = dFdy(vs_TEXCOORD1.x);
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_1.www;
