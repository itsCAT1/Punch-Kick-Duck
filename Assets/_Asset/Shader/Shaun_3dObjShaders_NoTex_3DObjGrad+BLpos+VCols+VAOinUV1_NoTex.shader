...
//
///////////////////////////////////////////
Shader "Shaun/3dObjShaders/NoTex/3DObjGrad+BLpos+VCols+VAOinUV1_NoTex" {
Properties {
...
void main()
{
    ...
    u_xlat0.x = u_xlat16_20 * 0.00499999989;
    ...
    u_xlat0.x = (-u_xlat16_2.x) * u_xlat16_20 + 1.0;
    ...
    u_xlat6 = (-in_TEXCOORD0.z) + 1.0;
    u_xlat0.x = max(u_xlat6, u_xlat0.x);
    u_xlat16_4.xyz = u_xlat0.xxx * _ShadowSub.xyz;
    u_xlat16_8 = (-u_xlat16_14) * _GradientLightCut + 1.0;
    u_xlat16_5.xyz = vec3(u_xlat16_14) * _GradientSubColor.xyz;
    u_xlat16_5.xyz = in_COLOR0.xyz * _DiffuseBaseCol.xyz + u_xlat16_5.xyz;
    u_xlat16_2.x = u_xlat16_8 * u_xlat16_2.x;
    u_xlat16_2.xyz = u_xlat16_2.xxx * _MainLightCol.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * in_TEXCOORD0.xxx + u_xlat16_4.xyz;
    u_xlat16_2.xyz = u_xlat16_3.xzw * in_TEXCOORD0.yyy + u_xlat16_2.xyz;
