...
_MetalCol ("Metal Col", Color) = (1,1,1,1)
_BodyCol ("Body Col", Color) = (1,1,1,1)
...
void main()
{
    ...
    u_xlat16_2.x = max(u_xlat16_2.x, _BackLightLimitForFrontFaces);
...
uniform 	mediump vec3 _MetalCol;
uniform 	mediump vec3 _BodyCol;
uniform 	mediump vec3 _ShadowSub;
uniform 	mediump float _TexAOStr;
...
void main()
{
    ...
    u_xlat16_1.x = u_xlat16_0.x * 0.649999976;
    u_xlat16_4 = (-u_xlat16_0.x) * 0.75 + 1.0;
    u_xlat16_1.xzw = u_xlat16_1.xxx * _ShadowSub.xyz;
    u_xlat16_1.xyz = vs_COLOR0.xyz * vec3(u_xlat16_4) + u_xlat16_1.xzw;
    u_xlat16_0.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_10 = u_xlat16_0.z * _TexAOStr;
    u_xlat16_2.xyz = vec3(u_xlat16_10) * _ShadowSub.xyz;
    u_xlat16_10 = (-u_xlat16_0.z) * _TexAOStr + 1.0;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(u_xlat16_10) + u_xlat16_2.xyz;
    u_xlat16_1.xyz = _ShadowSub.xyz * vs_COLOR0.www + u_xlat16_1.xyz;
    u_xlat16_2.xyz = u_xlat16_0.yyy * _BodyCol.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _DiffuseBaseCol.xyz;
    u_xlat16_2.xyz = u_xlat16_0.xxx * _MetalCol.xyz + u_xlat16_2.xyz;
