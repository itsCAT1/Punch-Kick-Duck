...
//
///////////////////////////////////////////
Shader "Shaun/CharShaders/CharShader_Alpha" {
Properties {
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(u_xlat16_11) * u_xlat16_2.xyz;
    u_xlat16_11 = u_xlat16_2.y * in_TANGENT0.x;
    vs_TEXCOORD4.y = u_xlat16_2.x * (-in_TANGENT0.y) + u_xlat16_11;
    vs_TEXCOORD4.x = dot(u_xlat16_2.xy, in_TANGENT0.xy);
    vs_TEXCOORD4.z = u_xlat16_2.z * (-hlslcc_mtx4x4unity_ObjectToWorld[2].z);
...
void main()
{
    u_xlat16_0.x = min(_BackLightLimiter, 1.0);
    u_xlat16_0.x = (-vs_COLOR0.x) * u_xlat16_0.x + 1.0;
    u_xlat16_0.x = max(u_xlat16_0.x, 0.0);
    u_xlat16_1 = texture2D(_MainTex, vs_TEXCOORD1.xy);
    u_xlat1.xyz = u_xlat16_1.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat16_4.x = dot(u_xlat1.xyz, vs_TEXCOORD4.xyz);
    u_xlat16_8 = dot(u_xlat1.xyz, vs_TEXCOORD3.xyz);
    u_xlat1.x = max(u_xlat16_4.x, 0.0);
    u_xlat1.x = u_xlat1.x * _BackLightDir.w;
    u_xlat1.x = u_xlat16_0.x * u_xlat1.x;
    u_xlat16_4.x = u_xlat1.x * 0.5;
    u_xlat1.x = _BackLightLimiter + 1.0;
    u_xlat1.x = u_xlat16_1.w * u_xlat1.x + (-_BackLightLimiter);
    u_xlat5 = max(u_xlat1.x, 0.0);
    u_xlat16_12 = (-u_xlat1.x) + u_xlat5;
    u_xlat16_12 = u_xlat16_12 * u_xlat16_4.x;
    u_xlat16_2.xyz = u_xlat16_4.xxx * _BackLightCol.xyz;
    u_xlat16_4.x = max(u_xlat16_12, vs_COLOR0.y);
    u_xlat16_3.xyz = u_xlat16_4.xxx * _ShadowSub.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * vec3(u_xlat5) + u_xlat16_3.xyz;
    u_xlat16_4.x = u_xlat16_8 * _MainLightDir.w;
    u_xlat1.x = max(u_xlat16_4.x, 0.0);
    u_xlat16_4.x = (-u_xlat16_8) * _MainLightDir.w + u_xlat1.x;
    u_xlat16_4.xyz = u_xlat16_4.xxx * _ShadowSub.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xxx * u_xlat16_4.xyz;
    u_xlat16_0.xyz = _MainLightCol.xyz * u_xlat1.xxx + u_xlat16_0.xyz;
