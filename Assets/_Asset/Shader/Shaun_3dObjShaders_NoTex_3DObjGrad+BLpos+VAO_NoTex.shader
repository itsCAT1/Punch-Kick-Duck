...
//
///////////////////////////////////////////
Shader "Shaun/3dObjShaders/NoTex/3DObjGrad+BLpos+VAO_NoTex" {
Properties {
...
void main()
{
    ...
    u_xlat16_2.xyz = (-u_xlat0.xyz) + _BackLightPos.xyz;
    ...
    u_xlat16_3.x = inversesqrt(u_xlat16_20);
    u_xlat16_20 = u_xlat16_20 * _BackLightPos.w;
    u_xlat16_20 = (-u_xlat16_20) * 0.00499999989 + 1.0;
    ...
    u_xlat16_3.x = u_xlat0.z * u_xlat18 + 0.800000012;
    ...
    u_xlat16_14 = dot(u_xlat0.xyz, in_POSITION0.xyz);
    u_xlat16_14 = u_xlat16_14 + (-_GradientStart);
    u_xlat16_3.x = (-_GradientStart) + _GradientEnd;
    u_xlat16_14 = u_xlat16_14 / u_xlat16_3.x;
    u_xlat16_14 = clamp(u_xlat16_14, 0.0, 1.0);
    u_xlat16_14 = u_xlat16_14 * _GradientSubColor.w;
    u_xlat16_3.xy = (-vec2(u_xlat16_14)) * vec2(_GradientBackLightCut, _GradientShadowCut) + vec2(1.0, 1.0);
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_3.x;
    u_xlat16_2.x = u_xlat16_20 * u_xlat16_2.x;
    u_xlat16_3.xzw = u_xlat16_2.xxx * _BackLightCol.xyz;
    u_xlat16_2.x = max(u_xlat16_8, 0.0);
    u_xlat16_8 = (-u_xlat16_8) + u_xlat16_2.x;
    u_xlat16_2.x = u_xlat16_2.x * _MainLightDir.w;
    u_xlat16_8 = u_xlat16_3.y * u_xlat16_8;
    u_xlat16_20 = (-in_COLOR0.z) + 1.0;
    u_xlat16_8 = max(u_xlat16_20, u_xlat16_8);
    u_xlat16_4.xyz = vec3(u_xlat16_8) * _ShadowSub.xyz;
    u_xlat16_8 = (-u_xlat16_14) * _GradientLightCut + 1.0;
    u_xlat16_5.xyz = vec3(u_xlat16_14) * _GradientSubColor.xyz;
    u_xlat16_5.xyz = _ObjectCol.xyz * _DiffuseBaseCol.xyz + u_xlat16_5.xyz;
    u_xlat16_2.x = u_xlat16_8 * u_xlat16_2.x;
    u_xlat16_2.xyz = u_xlat16_2.xxx * _MainLightCol.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * in_COLOR0.xxx + u_xlat16_4.xyz;
    u_xlat16_2.xyz = u_xlat16_3.xzw * in_COLOR0.yyy + u_xlat16_2.xyz;
    vs_COLOR0.xyz = u_xlat16_2.xyz + u_xlat16_5.xyz;
