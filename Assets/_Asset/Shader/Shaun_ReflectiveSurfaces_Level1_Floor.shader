...
//
///////////////////////////////////////////
Shader "Shaun/ReflectiveSurfaces/Level1_Floor" {
Properties {
...
void main()
{
    ...
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_3 + (-u_xlat16_6);
...
void main()
{
    ...
    u_xlat20 = (-u_xlat0.z) + _RefTexAdj.y;
    u_xlat0.y = u_xlat20 * _RefTexAdj.x;
    u_xlat16_1.xyz = texture2D(_MainTex, u_xlat0.xy).xyz;
    u_xlat16_2 = texture2D(_SurfaceTex, vs_TEXCOORD0.xy);
    u_xlat16_3 = u_xlat16_2.w + 0.0500000007;
    u_xlat16_13.xyz = u_xlat16_2.xyz + vs_COLOR1.xyz;
    u_xlat16_13.xyz = u_xlat16_13.xyz * vs_COLOR0.xyz;
    u_xlat16_3 = min(u_xlat16_3, 1.0);
    u_xlat16_4.xy = (-vec2(u_xlat16_3)) + vec2(1.0, 1.75);
    u_xlat16_3 = u_xlat16_3 * vs_TEXCOORD2.x;
    u_xlat16_4.x = dot(u_xlat16_4.xx, vec2(_VBlur));
    u_xlat16_24 = u_xlat0.x + u_xlat16_4.x;
    u_xlat16_34 = u_xlat0.x + (-u_xlat16_4.x);
    u_xlat0.x = u_xlat16_24;
    u_xlat16_24 = u_xlat16_4.x + u_xlat0.x;
    u_xlat16_2.xyz = texture2D(_MainTex, u_xlat0.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_1.xyz + u_xlat16_2.xyz;
    u_xlat0.x = u_xlat16_34;
    u_xlat16_6 = (-u_xlat16_4.x) + u_xlat0.x;
    u_xlat16_1.xyz = texture2D(_MainTex, u_xlat0.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_1.xyz + u_xlat16_5.xyz;
    u_xlat0.x = u_xlat16_24;
    u_xlat16_7 = u_xlat16_4.x + u_xlat0.x;
    u_xlat16_8 = (-u_xlat16_4.x) + u_xlat16_6;
    u_xlat6.x = u_xlat16_6;
    u_xlat8.x = u_xlat16_8;
    u_xlat7.x = u_xlat16_7;
    u_xlat16_0.xzw = texture2D(_MainTex, u_xlat0.xy).xyz;
    u_xlat6.y = u_xlat0.y;
    u_xlat16_4.xzw = u_xlat16_0.xzw + u_xlat16_5.xyz;
    u_xlat16_0.xyz = texture2D(_MainTex, u_xlat6.xy).xyz;
    u_xlat7.y = u_xlat6.y;
    u_xlat16_4.xzw = u_xlat16_0.xyz + u_xlat16_4.xzw;
    u_xlat16_0.xyz = texture2D(_MainTex, u_xlat7.xy).xyz;
    u_xlat8.y = u_xlat7.y;
    u_xlat16_1.xyz = texture2D(_MainTex, u_xlat8.xy).xyz;
    u_xlat16_4.xzw = u_xlat16_0.xyz + u_xlat16_4.xzw;
    u_xlat16_4.xzw = u_xlat16_1.xyz + u_xlat16_4.xzw;
    u_xlat16_5.xyz = (-u_xlat16_4.xzw) * vec3(0.143000007, 0.143000007, 0.143000007) + vec3(1.0, 1.0, 1.0);
    u_xlat16_9.xyz = (-u_xlat16_13.xyz) * u_xlat16_4.yyy + vec3(1.0, 1.0, 1.0);
    u_xlat16_5.xyz = (-u_xlat16_5.xyz) * u_xlat16_9.xyz + vec3(0.920000017, 0.920000017, 0.920000017);
    u_xlat16_4.xzw = u_xlat16_4.xzw * vec3(0.143000007, 0.143000007, 0.143000007) + (-u_xlat16_5.xyz);
    u_xlat16_4.xzw = vs_TEXCOORD2.yyy * u_xlat16_4.xzw + u_xlat16_5.xyz;
    u_xlat16_4.xzw = (-u_xlat16_13.xyz) * u_xlat16_4.yyy + u_xlat16_4.xzw;
    u_xlat16_13.xyz = u_xlat16_13.xyz * u_xlat16_4.yyy;
    SV_Target0.xyz = vec3(u_xlat16_3) * u_xlat16_4.xzw + u_xlat16_13.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat8.x = u_xlat16_8;
    u_xlat7.x = u_xlat16_7;
    u_xlat16_0.xzw = texture(_MainTex, u_xlat0.xy).xyz;
    u_xlat6.y = u_xlat0.y;
    u_xlat16_4.xzw = u_xlat16_0.xzw + u_xlat16_5.xyz;
    u_xlat16_0.xyz = texture(_MainTex, u_xlat6.xy).xyz;
    u_xlat7.y = u_xlat6.y;
    u_xlat16_4.xzw = u_xlat16_0.xyz + u_xlat16_4.xzw;
    u_xlat16_0.xyz = texture(_MainTex, u_xlat7.xy).xyz;
    u_xlat8.y = u_xlat7.y;
    u_xlat16_1.xyz = texture(_MainTex, u_xlat8.xy).xyz;
    u_xlat16_4.xzw = u_xlat16_0.xyz + u_xlat16_4.xzw;
    u_xlat16_4.xzw = u_xlat16_1.xyz + u_xlat16_4.xzw;
    u_xlat16_5.xyz = (-u_xlat16_4.xzw) * vec3(0.143000007, 0.143000007, 0.143000007) + vec3(1.0, 1.0, 1.0);
    u_xlat16_9.xyz = (-u_xlat16_13.xyz) * u_xlat16_4.yyy + vec3(1.0, 1.0, 1.0);
