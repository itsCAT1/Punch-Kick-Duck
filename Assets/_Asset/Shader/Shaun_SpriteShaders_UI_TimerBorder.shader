...
void main()
{
    ...
    u_xlat16_3.xy = texture2D(_MainTex, vs_TEXCOORD0.xy).zw;
    u_xlat0 = (-u_xlat0) + u_xlat16_3.x;
    u_xlat0 = u_xlat0 * 58.8235245;
    u_xlat0 = clamp(u_xlat0, 0.0, 1.0);
    u_xlat3 = u_xlat0 * -2.0 + 3.0;
    u_xlat0 = u_xlat0 * u_xlat0;
    u_xlat0 = u_xlat0 * u_xlat3;
    u_xlat16_1.xyz = _GradCol.xyz * vs_TEXCOORD0.zzz + _Color.xyz;
    u_xlat16_2.xyz = u_xlat16_1.xyz * vs_COLOR0.www;
    u_xlat16_1.xyz = (-u_xlat16_1.xyz) * vs_COLOR0.www + vs_COLOR0.xyz;
    u_xlat16_1.xyz = vec3(u_xlat0) * u_xlat16_1.xyz + u_xlat16_2.xyz;
    u_xlat16_1.w = vs_COLOR0.w;
    SV_Target0 = u_xlat16_3.yyyy * u_xlat16_1;
    return;
}
...
{
    u_xlat0 = _TimerValue + -0.00850000046;
    u_xlat16_3.xy = texture(_MainTex, vs_TEXCOORD0.xy).zw;
    u_xlat0 = (-u_xlat0) + u_xlat16_3.x;
    u_xlat0 = u_xlat0 * 58.8235245;
#ifdef UNITY_ADRENO_ES3
