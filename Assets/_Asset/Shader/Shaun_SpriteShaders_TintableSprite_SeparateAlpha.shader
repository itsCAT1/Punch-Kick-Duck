...
//
///////////////////////////////////////////
Shader "Shaun/SpriteShaders/TintableSprite_SeparateAlpha" {
Properties {
...
void main()
{
    ...
    u_xlat16_0.w = texture2D(_AlphaTex, vs_TEXCOORD0.xy).w;
...
void main()
{
    ...
    u_xlat16_0.w = texture(_AlphaTex, vs_TEXCOORD0.xy).w;
    SV_Target0 = u_xlat16_0 * vs_COLOR0;
    return;
}
