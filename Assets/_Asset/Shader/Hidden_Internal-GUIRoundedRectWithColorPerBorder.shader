...
void main()
{
    ...
    u_xlat10_9.x = (u_xlatb9.x) ? 1.0 : u_xlat27;
    u_xlat0.z = u_xlat10_9.x * u_xlat18;
    u_xlat10_9.z = texture2D(_GUIClipTexture, vs_TEXCOORD1.xy).w;
    u_xlatb1 = _SrcBlend!=5;
    u_xlat0.xz = u_xlat10_9.xz * u_xlat0.xz;
    u_xlat0.x = u_xlat10_9.z * u_xlat0.x;
