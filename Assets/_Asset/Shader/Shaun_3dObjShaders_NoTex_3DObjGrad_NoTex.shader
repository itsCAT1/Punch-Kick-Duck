...
//
///////////////////////////////////////////
Shader "Shaun/3dObjShaders/NoTex/3DObjGrad_NoTex" {
Properties {
...
void main()
{
    ...
    u_xlat16_6.x = u_xlat0.z * u_xlat12 + 0.75;
    u_xlat16_6.y = dot(u_xlat1.xyz, _BackLightDir.xyz);
    ...
    u_xlat16_6.x = u_xlat16_6.x * _BackLightDir.w;
    u_xlat16_10 = (-_GradientStart) + _GradientEnd;
    ...
    u_xlat16_10 = max(u_xlat16_14, 0.0);
    u_xlat16_14 = (-u_xlat16_14) + u_xlat16_10;
    u_xlat16_6.y = u_xlat16_10 * _MainLightDir.w;
    u_xlat16_6.xy = u_xlat16_6.xy * u_xlat16_3.yx;
    u_xlat16_3.x = (-u_xlat16_2.x) * _GradientShadowCut + 1.0;
    u_xlat16_14 = u_xlat16_14 * u_xlat16_3.x;
    u_xlat16_3.xyz = vec3(u_xlat16_14) * _ShadowSub.xyz;
    u_xlat16_3.xyz = _MainLightCol.xyz * u_xlat16_6.yyy + u_xlat16_3.xyz;
    u_xlat16_6.xyz = _BackLightCol.xyz * u_xlat16_6.xxx + u_xlat16_3.xyz;
    u_xlat16_2.xyz = _GradientSubColor.xyz * u_xlat16_2.xxx + u_xlat16_6.xyz;
