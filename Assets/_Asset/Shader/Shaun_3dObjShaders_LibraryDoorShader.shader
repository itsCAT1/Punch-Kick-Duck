...
//
///////////////////////////////////////////
Shader "Shaun/3dObjShaders/LibraryDoorShader" {
Properties {
...
void main()
{
    ...
    u_xlat1 = hlslcc_mtx4x4unity_ObjectToWorld[3].zxyz * in_POSITION0.wwww + u_xlat0.zxyz;
    u_xlat16_3 = u_xlat0.y + (-_GradientStart);
    u_xlat16_12.xyz = (-u_xlat1.yzw) + _BackLightPos.xyz;
    u_xlat16_4.x = dot(u_xlat16_12.xyz, u_xlat16_12.xyz);
    u_xlat16_13 = inversesqrt(u_xlat16_4.x);
    u_xlat16_4.x = u_xlat16_4.x * _BackLightPos.w;
    u_xlat16_4.x = (-u_xlat16_4.x) * 0.00499999989 + 1.0;
    u_xlat16_4.x = clamp(u_xlat16_4.x, 0.0, 1.0);
    u_xlat16_4.x = u_xlat16_4.x * u_xlat16_4.x;
    u_xlat16_12.xyz = u_xlat16_12.xyz * vec3(u_xlat16_13);
    ...
    u_xlat16_13 = u_xlat0.z * u_xlat27 + 0.800000012;
    u_xlat16_13 = max(u_xlat16_13, _BackLightLimitForFrontFaces);
    ...
    u_xlat16_12.x = u_xlat16_12.x * _BackLightDir.w;
    u_xlat16_21.x = (-_GradientStart) + _GradientEnd;
    u_xlat16_3 = u_xlat16_3 / u_xlat16_21.x;
    u_xlat16_3 = clamp(u_xlat16_3, 0.0, 1.0);
    u_xlat16_3 = u_xlat16_3 * _GradientSubColor.w;
    u_xlat16_21.xy = (-vec2(u_xlat16_3)) * vec2(_GradientBackLightCut, _GradientShadowCut) + vec2(1.0, 1.0);
    u_xlat16_12.x = u_xlat16_21.x * u_xlat16_12.x;
    u_xlat16_12.x = u_xlat16_4.x * u_xlat16_12.x;
    u_xlat16_4.xzw = u_xlat16_12.xxx * _BackLightCol.xyz;
    u_xlat16_12.x = (-u_xlat16_3) * _GradientLightCut + 1.0;
    u_xlat16_5.x = dot(u_xlat2.xyz, _MainLightDir.xyz);
    u_xlat16_14.x = max(u_xlat16_5.x, 0.0);
    u_xlat16_5.x = (-u_xlat16_5.x) + u_xlat16_14.x;
    u_xlat16_14.x = u_xlat16_14.x * _MainLightDir.w;
    u_xlat16_12.x = u_xlat16_12.x * u_xlat16_14.x;
    u_xlat16_14.xyz = u_xlat16_12.xxx * _MainLightCol.xyz;
    u_xlat16_12.x = u_xlat16_21.y * u_xlat16_5.x;
    u_xlat16_30 = (-u_xlat1.x) + 5.0;
    u_xlat16_30 = clamp(u_xlat16_30, 0.0, 1.0);
    u_xlat16_6.xyz = (-u_xlat1.yzw) + _BackLight2Pos.xyz;
    u_xlat16_7.xyz = (-in_COLOR0.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_7.xyz = vec3(u_xlat16_30) * u_xlat16_7.xyz + in_COLOR0.xyz;
    u_xlat16_30 = (-u_xlat16_7.z) + 1.0;
    u_xlat16_12.x = max(u_xlat16_30, u_xlat16_12.x);
    u_xlat16_8.xyz = u_xlat16_12.xxx * _ShadowSub.xyz;
    u_xlat16_5.xyz = u_xlat16_14.xyz * u_xlat16_7.xxx + u_xlat16_8.xyz;
    u_xlat16_4.xzw = u_xlat16_4.xzw * u_xlat16_7.yyy + u_xlat16_5.xyz;
    u_xlat16_12.x = dot(u_xlat16_6.xyz, u_xlat16_6.xyz);
    u_xlat16_30 = inversesqrt(u_xlat16_12.x);
    u_xlat16_12.x = u_xlat16_12.x * _BackLight2Pos.w;
    u_xlat16_12.x = (-u_xlat16_12.x) * 0.00499999989 + 1.0;
    u_xlat16_12.x = clamp(u_xlat16_12.x, 0.0, 1.0);
    u_xlat16_12.x = u_xlat16_12.x * u_xlat16_12.x;
    u_xlat16_5.xyz = vec3(u_xlat16_30) * u_xlat16_6.xyz;
    u_xlat16_30 = dot(u_xlat2.xyz, u_xlat16_5.xyz);
    u_xlat16_30 = max(u_xlat16_30, 0.0);
    u_xlat16_30 = u_xlat16_13 * u_xlat16_30;
    u_xlat16_30 = u_xlat16_30 * _BackLight2Dir.w;
    u_xlat16_21.x = u_xlat16_21.x * u_xlat16_30;
    u_xlat16_12.x = u_xlat16_12.x * u_xlat16_21.x;
    u_xlat16_12.xyz = u_xlat16_12.xxx * _BackLight2Col.xyz;
    u_xlat16_12.xyz = u_xlat16_12.xyz * u_xlat16_7.yyy + u_xlat16_4.xzw;
    vs_COLOR0.xyz = _GradientSubColor.xyz * vec3(u_xlat16_3) + u_xlat16_12.xyz;
    return;
}
