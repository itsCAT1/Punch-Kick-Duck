...
void main()
{
    u_xlat0.xyz = (-_AmbCol.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_6 = texture2D(_ShadTex, vs_TEXCOORD0.xy).y;
    u_xlat16_1.x = u_xlat16_6 * vs_COLOR1.w;
    u_xlat16_3.x = u_xlat16_6 * vs_COLOR1.w + _AmbCol.w;
    u_xlat6 = min(u_xlat16_3.x, 1.0);
    u_xlat16_3.xyz = vec3(u_xlat6) * vs_COLOR0.xyz;
    u_xlat0.xyz = u_xlat16_1.xxx * u_xlat0.xyz + _AmbCol.xyz;
    u_xlat16_1.xyz = _DiffuseBaseTint.xyz * u_xlat0.xyz + u_xlat16_3.xyz;
    SV_Target0.xyz = u_xlat16_1.xyz * vs_COLOR1.xyz;
    SV_Target0.w = _DiffuseBaseTint.w;
    return;
}
...
{
    u_xlat0.xyz = (-_AmbCol.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_6 = texture(_ShadTex, vs_TEXCOORD0.xy).y;
    u_xlat16_1.x = u_xlat16_6 * vs_COLOR1.w;
    u_xlat16_3.x = u_xlat16_6 * vs_COLOR1.w + _AmbCol.w;
    u_xlat6 = min(u_xlat16_3.x, 1.0);
    u_xlat16_3.xyz = vec3(u_xlat6) * vs_COLOR0.xyz;
