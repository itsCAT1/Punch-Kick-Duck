...
void main()
{
    ...
    u_xlat10_0.w = texture2D(_MainTex, u_xlat1.xy).y;
    SV_Target0 = u_xlat10_0;
    return;
}
...
void main()
{
    ...
    u_xlat10_0.yz = texture2D(_SecondTex, vs_TEXCOORD0.xy).xy;
    u_xlat0.xyz = u_xlat10_0.xyz * vec3(64.0615845, 64.0615845, 64.0615845) + vec3(-0.0625, -0.5, -0.5);
