...
//
///////////////////////////////////////////
Shader "Shaun/LightAndShade/FakeAOShader" {
Properties {
_MainTex ("Base (RGB)", 2D) = "white" { }
_AOColor ("AO Color (Alpha = strength)", Color) = (0,0,0,1)
}
SubShader {
...
void main()
{
    ...
    vs_COLOR0.xyz = _AOColor.www * _AOColor.xyz;
    vs_COLOR0.w = _AOColor.w;
    return;
}
...
void main()
{
    ...
    SV_Target0 = vec4(u_xlat16_0) * vs_COLOR0;
    return;
}
