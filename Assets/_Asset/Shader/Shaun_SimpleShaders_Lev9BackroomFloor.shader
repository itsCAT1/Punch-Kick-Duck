...
_TintMulti1 ("Tint and opac 1", Color) = (0,0,0,0)
_TintMulti2 ("Tint and opac 2", Color) = (0,0,0,0)
...
uniform 	mediump vec4 _TintMulti1;
uniform 	mediump vec4 _TintMulti2;
...
void main()
{
    ...
    u_xlat16_0 = _TintMulti1 + (-_TintMulti2);
    vs_COLOR0 = vec4(_LerpFactor) * u_xlat16_0 + _TintMulti2;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.xyz = (-u_xlat16_0.xyz) * vs_COLOR0.xyz + _ZDarkCol.xyz;
