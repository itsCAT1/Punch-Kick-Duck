...
void main()
{
    ...
    u_xlat16_0.xyz = vec3(u_xlat16_11) * u_xlat16_2.xyz;
    u_xlat16_0.w = u_xlat16_0.z * (-hlslcc_mtx4x4unity_ObjectToWorld[2].z);
    vs_TEXCOORD3.xyz = u_xlat16_0.xyw;
...
void main()
{
    ...
    u_xlat16_1 = texture2D(_NormalMapTex, vs_TEXCOORD1.xy);
    u_xlat0 = u_xlat16_1.w * u_xlat0 + (-_BackLightLimiter);
    u_xlat16_2.xyz = u_xlat16_1.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat5 = max(u_xlat0, 0.0);
    u_xlat16_17 = (-u_xlat0) + u_xlat5;
    u_xlat16_3.x = dot(u_xlat16_2.xyz, vs_TEXCOORD3.xyz);
    u_xlat16_2.x = dot(u_xlat16_2.xyz, vs_TEXCOORD2.xyz);
    u_xlat0 = max(u_xlat16_3.x, 0.0);
    u_xlat0 = u_xlat0 * _BackLightDir.w;
    u_xlat16_7.x = u_xlat0 * 0.5;
    u_xlat16_3.xyz = u_xlat16_7.xxx * _ShadowSub.xyz;
    u_xlat16_4.xyz = u_xlat16_7.xxx * _BackLightCol.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_17) * u_xlat16_3.xyz;
    u_xlat16_7.xyz = u_xlat16_4.xyz * vec3(u_xlat5) + u_xlat16_7.xyz;
    u_xlat16_3.x = u_xlat16_2.x * _MainLightDir.w;
    u_xlat0 = max(u_xlat16_3.x, 0.0);
    u_xlat16_2.x = (-u_xlat16_2.x) * _MainLightDir.w + u_xlat0;
    u_xlat16_3.xyz = u_xlat16_2.xxx * _ShadowSub.xyz;
    ...
    SV_Target0.xyz = u_xlat16_0.xyz * _DiffuseBaseCol.xyz + u_xlat16_2.xyz;
...
{
    u_xlat0 = _BackLightLimiter + 1.0;
    u_xlat16_1 = texture(_NormalMapTex, vs_TEXCOORD1.xy);
    u_xlat0 = u_xlat16_1.w * u_xlat0 + (-_BackLightLimiter);
    u_xlat16_2.xyz = u_xlat16_1.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat5 = max(u_xlat0, 0.0);
    u_xlat16_17 = (-u_xlat0) + u_xlat5;
