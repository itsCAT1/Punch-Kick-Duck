...
//
///////////////////////////////////////////
Shader "Shaun/SpriteShaders/NumberLabelSprite" {
Properties {
...
void main()
{
    ...
    u_xlat16_1 = u_xlat16_0.xxxx * vs_COLOR0;
    u_xlat16_1.xyz = (-_Color.xyz) * u_xlat16_0.yyy + u_xlat16_1.xyz;
    u_xlat16_2 = u_xlat16_0.z * vs_COLOR0.w;
