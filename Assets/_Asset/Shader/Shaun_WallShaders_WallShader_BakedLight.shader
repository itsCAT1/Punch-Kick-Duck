...
//
///////////////////////////////////////////
Shader "Shaun/WallShaders/WallShader_BakedLight" {
Properties {
...
void main()
{
    ...
    u_xlat16_10 = u_xlat16_2.x * _ShadPosAndScale.w + (-u_xlat16_6.y);
    ...
    vs_TEXCOORD1.y = (-u_xlat16_14) + u_xlat16_10;
    u_xlat0.x = hlslcc_mtx4x4unity_ObjectToWorld[0].x;
    u_xlat0.y = hlslcc_mtx4x4unity_ObjectToWorld[1].x;
    u_xlat0.z = hlslcc_mtx4x4unity_ObjectToWorld[2].x;
    u_xlat16_10 = dot(u_xlat0.xyz, in_POSITION0.xyz);
    u_xlat16_6.x = u_xlat16_10 * _ShadPosAndScale.z + (-u_xlat16_6.x);
    vs_TEXCOORD1.x = u_xlat16_6.x + 0.5;
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
    u_xlat16_3.xy = _AmbPosAndScale.zw * _AmbPosAndScale.xy;
    u_xlat16_2.x = u_xlat16_2.x * _AmbPosAndScale.w + (-u_xlat16_3.y);
    u_xlat16_2.y = u_xlat16_10 * _AmbPosAndScale.z + (-u_xlat16_3.x);
    u_xlat16_2.x = (-u_xlat16_14) + u_xlat16_2.x;
    vs_TEXCOORD2.xy = u_xlat16_2.yx + vec2(0.5, 0.5);
...
void main()
{
    u_xlat16_0.x = texture2D(_ShadTex, vs_TEXCOORD1.xy).x;
    u_xlat16_1.xyz = u_xlat16_0.xxx * vs_COLOR0.xyz;
    u_xlat16_0.x = texture2D(_ShadTex, vs_TEXCOORD2.xy).y;
    u_xlat16_13 = u_xlat16_0.x + _AmbCol.w;
    u_xlat4 = min(u_xlat16_13, 1.0);
    u_xlat16_1.xyz = vec3(u_xlat4) * u_xlat16_1.xyz;
    u_xlat16_2.xyz = (-_AmbCol.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_2.xyz = u_xlat16_0.xxx * u_xlat16_2.xyz + _AmbCol.xyz;
    u_xlat16_0 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_0.xyz;
    SV_Target0.w = u_xlat16_0.w;
    u_xlat16_3.xyz = _DiffuseBaseTint.www + _DiffuseBaseTint.xyz;
...
void main()
{
    u_xlat16_0.x = texture(_ShadTex, vs_TEXCOORD1.xy).x;
    u_xlat16_1.xyz = u_xlat16_0.xxx * vs_COLOR0.xyz;
    u_xlat16_0.x = texture(_ShadTex, vs_TEXCOORD2.xy).y;
    u_xlat16_13 = u_xlat16_0.x + _AmbCol.w;
    u_xlat4 = min(u_xlat16_13, 1.0);
    u_xlat16_1.xyz = vec3(u_xlat4) * u_xlat16_1.xyz;
    u_xlat16_2.xyz = (-_AmbCol.xyz) + vec3(1.0, 1.0, 1.0);
