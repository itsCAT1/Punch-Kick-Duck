...
void main()
{
    ...
    u_xlatb12 = u_xlatb18 || u_xlatb12;
    u_xlat10_6.x = (u_xlatb12) ? u_xlat6 : 1.0;
    u_xlat0.z = u_xlat10_6.x * u_xlat0.x;
    u_xlat10_6.z = texture2D(_GUIClipTexture, vs_TEXCOORD1.xy).w;
    ...
    u_xlat0.xz = u_xlat10_6.xz * u_xlat0.xz;
    u_xlat0.x = u_xlat10_6.z * u_xlat0.x;
