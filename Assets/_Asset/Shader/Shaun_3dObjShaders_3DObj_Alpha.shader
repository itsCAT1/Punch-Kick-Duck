...
//
///////////////////////////////////////////
Shader "Shaun/3dObjShaders/3DObj_Alpha" {
Properties {
...
void main()
{
    ...
    u_xlat16_2.x = u_xlat0.z * u_xlat12 + 0.600000024;
    u_xlat16_2.y = dot(u_xlat1.xyz, _BackLightDir.xyz);
    ...
    u_xlat16_6.x = max(u_xlat16_10, 0.0);
    u_xlat16_10 = (-u_xlat16_10) + u_xlat16_6.x;
    u_xlat16_6.x = u_xlat16_6.x * _MainLightDir.w;
    u_xlat16_3.xyz = vec3(u_xlat16_10) * _ShadowSub.xyz;
    u_xlat16_6.xyz = _MainLightCol.xyz * u_xlat16_6.xxx + u_xlat16_3.xyz;
    vs_COLOR0.xyz = _BackLightCol.xyz * u_xlat16_2.xxx + u_xlat16_6.xyz;
    return;
}
